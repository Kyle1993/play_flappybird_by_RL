...
#
#     def append(self, state, prob, action, next_state, reward, done):
#         self.current_index = (self.current_index + 1) % self.max_len
#         self.memory[self.current_index] = (state, prob, action, next_state, reward, done)
#         self.counter += 1
#
#     def sample(self):
...
#         prob_batch = np.asarray(batch[1],dtype=np.float32)
...
#
#         return state_batch, prob_batch, action_batch, next_state_batch, reward_batch, done_batch
